...
````{r}
harmEcon$Deflator <- unlist(lapply(harmEcon$YEAR, function(x) 
  cpiDeflator$Deflator[cpiDeflator$Year == x]))
...
```{r,warning=FALSE,fig.align='center',fig.width=10,fig.height=8,cache=FALSE}
require(ggplot2)
library(scales)
